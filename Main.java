...
class Account {
    ...
    public Account(String accountHolderName, String email, String phone, String bankName, String accountNumber) {
...
class AccountManager {
   ...
   // account number like ACC100001, ACC100002, ...
    ...
    public void createAccount() {
        ...
        Account newAccount = new Account(name, email, phone, bank, accountNumber);
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (acc1 != null) {
                        ...
                        double creditAmount;
                        try {
                            creditAmount = Double.parseDouble(scanner.nextLine());
                ...
                case 3:
                    ...
                    if (acc2 != null) {
                        ...
                        double debitAmount;
                        try {
                            debitAmount = Double.parseDouble(scanner.nextLine());
